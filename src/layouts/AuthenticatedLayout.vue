              ...
              <li class="p-0">
                <div class="w-full flex flex-row justify-start items-center">
                  <div class="flex justify-center items-center pr-1">
                    <div class="flex justify-center items-center pr-1 rounded gap-1">
                    ...
                    <a :href="'tel:' + phone" class="w-full text-md pl-1">{{ phone }}</a>
                  </div>
                </div>
              </li>
              <li class="p-0" @click="window.open(`https://www.google.com/maps/search/?api=1&query=${address}`, '_blank')">
                <div class="w-full flex flex-row justify-start items-center">
                  <div class="flex justify-center items-center pr-1">
...
export default defineComponent({
  ...
  computed: {
    ...
    address() {
      ...
      return this.restaurant?.place + ', ' + this.restaurant?.city +  ', ' + this.restaurant?.country;
    },
    phone() {
