  ...
  <div class="card w-full bg-base-100 shadow-xl">
    <div class="card-body min-h-[100px]">
      <div class="flex justify-between items-start card-title">
        ...
        <div class="card bg-base-100 btn btn-square btn-ghost btn-sm flex justify-center start-center self-start"
             @click="onAddComment" v-if="showCompactly">
      ...
      <div class="flex-grow" v-if="showDescription">
        <p class="">
          {{ description }}
        </p>
      </div>
      ...
      <div class="flex flex-wrap-reverse justify-between items-start card-title" v-if="!showCompactly">

        <div class="w-full max-w-[200px] flex justify-center items-center" v-if="showServeAt && current !== null">
        ...
        <div class="flex justify-center items-start card-title" v-if="!showActionsOnSide">
          <div class="btn btn-square btn-ghost btn-sm flex justify-center start-center self-start" v-show="showServeAt && (!current?.serveAt || !current?.serveAt?.length) && !showServingTime"
          ...
          <div class="btn btn-square btn-ghost btn-sm flex justify-center start-center self-start"
               @click="onDuplicate">
            <BaseIcon title="duplicate" color="transparent" :width="24" :height="24" viewBox="0 0 24 24">
