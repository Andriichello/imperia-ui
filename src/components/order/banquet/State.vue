<template>
  <div class="banquet-state">
    <BaseIcon :width="20" :height="20" title="state" color="currentColor" class="grow-0">
      <g>
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M11.9941 16.75C11.5801 16.75 11.2441 16.414 11.2441 16V12C11.2441 11.586 11.5801 11.25 11.9941 11.25C12.4081 11.25 12.7441 11.586 12.7441 12V16C12.7441 16.414 12.4081 16.75 11.9941 16.75Z" />
    ...
    <span class="text-md font-semibold grow text-center text-current">
      {{ state ?? 'draft' }}
    </span>
  </div>
</template>
...
<style scoped>
.banquet-state {
  @apply flex justify-between items-center rounded pl-2 pr-2 py-1 gap-1 bg-base-200;
}
</style>