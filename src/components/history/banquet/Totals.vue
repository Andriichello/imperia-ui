<template>
  <div class="flex basis-full flex-col gap-1">
    ...
    <div class="groups">
      <div class="group">
        <BaseIcon :width="32" :height="32" title="products" viewBox="0 0 64 64" color="var(--text-color)" class="grow-0">
      ...
      <div class="group">
        <BaseIcon :width="32" :height="32" title="spaces" viewBox="0 0 64 64" color="var(--text-color)" class="grow-0">
      ...
      <div class="group">
        <BaseIcon :width="32" :height="32" title="tickets" viewBox="0 0 64 64" color="var(--text-color)" class="grow-0">
      ...
      <div class="group">
        <BaseIcon :width="32" :height="32" title="services" viewBox="0 0 64 64" color="var(--text-color)" class="grow-0">
    ...
    <div class="totals">
      <div class="totals-group">
        <span class="discount-label" v-if="discount">Discount: </span>
...
.groups {
  @apply flex basis-full justify-between items-baseline pl-2 pr-2 gap-1;
}

.totals {
  @apply flex basis-full justify-between pl-2 pr-2 gap-1;
}
