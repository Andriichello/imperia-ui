<template>
  <div class="switcher" id="order-switcher">
    <div class="w-full flex justify-start items-center p-3 px-4 rounded selected gap-2 cursor-pointer"
      ...
      <span class="loading loading-spinner loading-sm" v-if="isLoadingOrder || isCreatingOrder || isUpdatingOrder"></span>

      <template v-if="isEmpty">
        <BaseIcon title="products" color="text-black" :width="32" :height="32" viewBox="0 0 64 64" v-if="isEmpty && !(isLoadingOrder)">
