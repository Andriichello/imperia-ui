<template>
  <div class="title-container">
    <BaseIcon :width="24" :height="24" title="title" :color="iconColor">
...
export default defineComponent({
  ...
  computed: {
    title: {
      get() {
        return this.$store.getters['basket/title'];
      },
      set(value) {
        return this.$store.commit('basket/setTitle', value);
      },
    },
    iconColor() {
...
<style scoped>
  ...
  .title-input {
    @apply input w-full p-0 ml-1 mr-1 h-auto;
