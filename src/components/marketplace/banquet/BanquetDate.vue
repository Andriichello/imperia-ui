<template>
  <div class="date">
    <BaseIcon :width="32" :height="32" color="var(--text-color)" class="grow-0">
      ...
      <mask id="mask0_60_12020" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="2" y="2" width="20" height="21">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M2 2.5791H21.5V22.5H2V2.5791Z"/>
      </mask>
      <g mask="url(#mask0_60_12020)">
...
<style scoped>
.date {
  @apply flex flex-wrap p-1 gap-1 justify-center items-center;
}
