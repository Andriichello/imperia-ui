<template>
  <div class="time-picker">
    <div class="hour">
      ...
      <input type="number" class="hour-input text-2xl"
    ...
    <div class="minute">
      ...
      <input type="number" class="minute-input text-2xl"
...
export default defineComponent({
  ...
  name: "Time",
  emits: ["time-change", "do-something"],
  components: {
    BaseIcon,
  },
  props: {
...
.hour-up, .hour-down, .minute-up, .minute-down {
  @apply w-7 h-7 p-1 btn-ghost rounded-md;
}
</style>
