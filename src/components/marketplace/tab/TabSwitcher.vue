<template>
  <div class="switcher">
    <!-- <TabSwitcherItem tab="info" :selected="isTabSelected('info')" @switch-tab="onSwitchTab">
     ...
     <TabSwitcherItem tab="products" :selected="isTabSelected('products')" @switch-tab="onSwitchTab">
      <BaseIcon title="products" :color="getTabIconColor('products')" width="32" height="32" viewBox="0 0 64 64">
     ...
     <TabSwitcherItem tab="spaces" :selected="isTabSelected('spaces')" @switch-tab="onSwitchTab">
      <BaseIcon title="spaces" :color="getTabIconColor('spaces')" width="32" height="32" viewBox="0 0 64 64">
     ...
     <TabSwitcherItem tab="tickets" :selected="isTabSelected('tickets')" @switch-tab="onSwitchTab">
      <BaseIcon title="tickets" :color="getTabIconColor('tickets')" width="32" height="32" viewBox="0 0 64 64">
        ...
        <path d="M43.2,33v-3.1l.8,0,.2,3.2Z" />      </BaseIcon>
    </TabSwitcherItem>

     <TabSwitcherItem tab="services" :selected="isTabSelected('services')" @switch-tab="onSwitchTab">
      <BaseIcon title="services" :color="getTabIconColor('services')" width="32" height="32" viewBox="0 0 64 64">
...
export default defineComponent({
  ...
  methods: {
    ...
    getTabIconColor(tab) {
     return this.isTabSelected(tab) 
        ? 'var(--d-black)' : 'var(--icon-color)';
    },
    onSwitchTab(tab) {
