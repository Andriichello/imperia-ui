  ...
  <div class="container">
    ...
    <div class="flex flex-row justify-start w-full min-h-[80px] gap-2">
      <div class="details flex flex-col justify-start items-start gap-1 grow">
        ...
        <div class="w-full flex flex-col justify-start items-start gap-1 mt-1">

          <div class="w-full flex flex-row justify-start items-center gap-1" v-if="address?.length">
            <div class="w-5 h-5 flex justify-center items-center p-1 rounded">
              <BaseIcon width="16" height="16" :title="title" view-box="0 0 24 24" v-if="!imageLoaded">
                  <g id="Iconly/Light-Outline/Location">
                    <g id="Location">
                      <path id="Fill 1" fill-rule="evenodd" clip-rule="evenodd" d="M12.2505 8.5C11.2855 8.5 10.5005 9.285 10.5005 10.251C10.5005 11.216 11.2855 12 12.2505 12C13.2155 12 14.0005 11.216 14.0005 10.251C14.0005 9.285 13.2155 8.5 12.2505 8.5ZM12.2505 13.5C10.4585 13.5 9.00049 12.043 9.00049 10.251C9.00049 8.458 10.4585 7 12.2505 7C14.0425 7 15.5005 8.458 15.5005 10.251C15.5005 12.043 14.0425 13.5 12.2505 13.5Z" fill="black"/>
                      <g id="Group 5">
                  ...
                  <g id="Calling">
                    <g id="Group 3">
                      <mask id="mask0_33437_4674" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="14" y="2" width="9" height="9">
                        <path id="Clip 2" fill-rule="evenodd" clip-rule="evenodd" d="M14.354 2.00024H22.893V10.5331H14.354V2.00024Z" fill="white"/>
                      </mask>
                      <g mask="url(#mask0_33437_4674)">
                        <path id="Fill 1" fill-rule="evenodd" clip-rule="evenodd" d="M22.1427 10.5331C21.7657 10.5331 21.4417 10.2501 21.3987 9.86706C21.0197 6.49106 18.3977 3.87106 15.0207 3.49606C14.6097 3.45006 14.3127 3.08006 14.3587 2.66806C14.4037 2.25706 14.7707 1.95406 15.1867 2.00606C19.2647 2.45906 22.4317 5.62206 22.8887 9.69906C22.9347 10.1111 22.6387 10.4821 22.2277 10.5281C22.1997 10.5311 22.1707 10.5331 22.1427 10.5331Z" fill="black"/>
                      </g>
                    </g>
                    <path id="Fill 4" fill-rule="evenodd" clip-rule="evenodd" d="M18.6026 10.5439C18.2506 10.5439 17.9376 10.2959 17.8676 9.93791C17.5796 8.45791 16.4386 7.31691 14.9606 7.02991C14.5536 6.95091 14.2886 6.55791 14.3676 6.15091C14.4466 5.74391 14.8466 5.47791 15.2466 5.55791C17.3276 5.96191 18.9346 7.56791 19.3396 9.64991C19.4186 10.0579 19.1536 10.4509 18.7476 10.5299C18.6986 10.5389 18.6506 10.5439 18.6026 10.5439Z" fill="black"/>
                  </g>
