<template>
  <div class="card w-full bg-base-100 shadow-xl">
    <div class="w-full max-h-[180px] h-[180px] select-none" v-if="showImage && image">
      <figure class="w-full max-h-[180px] h-[180px] rounded-t-box">
        <img :alt="title" :src="image"
             class="overflow-hidden"
             style="object-fit: cover;"
             @load="imageLoaded = true"
             v-show="imageLoaded"/>
        <div v-show="!imageLoaded" class="w-full h-full skeleton flex justify-center items-center">
          <BaseIcon title="products" color="currentColor" :width="64" :height="64" viewBox="0 0 64 64">
