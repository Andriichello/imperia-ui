<template>
  <div class="card w-full bg-base-100 shadow-xl hover:bg-base-300/60 cursor-pointer">
    <figure class="h-[200px] bg-neutral">
      <BaseIcon v-if="!image" :width="80" :height="80" view-box="0 0 64 64" class="text-neutral-content">
    ...
    <div class="card-body min-h-[188px]">
      <div>
...
export default defineComponent({
  ...
  computed: {
    ...
    categories() {
      ...
      console.log(this.$store.getters['marketplace/categories']('products'));
      return this.$store.getters['marketplace/categories']('products')
