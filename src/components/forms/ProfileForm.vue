      ...
      <div class="profile-card-body">
        ...
        <div class="form-control w-full max-w-md">
           <div class="form-control w-full max-w-md">
            ...
            <input v-model="name" type="text" placeholder="Name..." class="input input-bordered w-full max-w-md" />
          </div>
          ...
          <div class="form-control w-full max-w-md">
            ...
            <input v-model="email" type="text" placeholder="Email..." class="input input-bordered w-full max-w-md" />
          </div>
        </div>
        ...
        <div class="w-full max-w-md gap-1 mt-2">
           <div class="flex w-full max-w-md pt-1 pb-1 pl-2 pr-2">
            ...
            <span class="font-semibold flex-grow text-end">{{ user.created_at }}</span>
          </div>
           <div class="flex w-full max-w-md pt-1 pb-1 pl-2 pr-2">
            <span class="label-text">Verified at:</span>
            <span class="font-semibold flex-grow text-end">{{ user.email_verified_at ?? 'Not verified' }}</span>
          </div>
        </div>
        ...
        <div class="card-actions w-full justify-end pt-4">
          ...
          <button @click="onLogOut" class="btn btn-group btn-error gap-1">
            <BaseIcon title="logout" width="24" height="24" viewBox="0 0 24 24" color="var(--error-btn-text)"> 
...
export default defineComponent({
  ...
  methods: {
    nameChanged() {
      return this.name !== (this.user.name + ' ' + this.user.surname);
    },
    emailChanged() {
