...
export class MenusApi extends runtime.BaseAPI {
     ...
     * Index menus.
     */
    async indexMenusRaw(requestParameters: IndexMenusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IndexMenuResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => IndexMenuResponseFromJSON(jsonValue));
    }

    /**
     * Index menus.
     */
    async indexMenus(requestParameters: IndexMenusRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IndexMenuResponse> {
     ...
     * Show menus by id.
     */
    async showMenuRaw(requestParameters: ShowMenuRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowMenuResponse>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling showMenu.');
        }
     ...
     * Show menus by id.
     */
    async showMenu(requestParameters: ShowMenuRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShowMenuResponse> {
