...
export class MediaApi extends runtime.BaseAPI {
   ...
   * Delete media.
   */
  async destroyMediaRaw(
    requestParameters: DestroyMediaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<DestroyMediaResponse>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling destroyMedia."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      DestroyMediaResponseFromJSON(jsonValue)
    );
  }
  ...
  async destroyMedia(
    requestParameters: DestroyMediaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<DestroyMediaResponse> {
    const response = await this.destroyMediaRaw(
      requestParameters,
      initOverrides
    );
   ...
   * Get model\'s media.
   */
  async getModelMediaRaw(
    requestParameters: GetModelMediaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<GetModelMediaResponse>> {
    if (
      requestParameters.modelId === null ||
      requestParameters.modelId === undefined
    ) {
      throw new runtime.RequiredError(
        "modelId",
        "Required parameter requestParameters.modelId was null or undefined when calling getModelMedia."
      );
    }

    if (
      requestParameters.modelType === null ||
      requestParameters.modelType === undefined
    ) {
      throw new runtime.RequiredError(
        "modelType",
        "Required parameter requestParameters.modelType was null or undefined when calling getModelMedia."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      GetModelMediaResponseFromJSON(jsonValue)
    );
  }
  ...
  async getModelMedia(
    requestParameters: GetModelMediaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<GetModelMediaResponse> {
    const response = await this.getModelMediaRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
   ...
   */
  async indexMediaRaw(
    requestParameters: IndexMediaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      IndexMediaResponseFromJSON(jsonValue)
    );
  }
   ...
   * Set model\'s media.
   */
  async setModelMediaRaw(
    requestParameters: SetModelMediaOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<SetModelMediaResponse>> {
    const queryParameters: any = {};
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SetModelMediaRequestToJSON(
          requestParameters.setModelMediaRequest
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      SetModelMediaResponseFromJSON(jsonValue)
    );
  }
  ...
  async setModelMedia(
    requestParameters: SetModelMediaOperationRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<SetModelMediaResponse> {
    const response = await this.setModelMediaRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  async showMediaRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ShowMediaResponse>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling showMedia."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ShowMediaResponseFromJSON(jsonValue)
    );
  }
   ...
   */
  async storeMediaRaw(
    requestParameters: StoreMediaRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<StoreMediaResponse>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      StoreMediaResponseFromJSON(jsonValue)
    );
  }
  ...
  async updateMediaRaw(
    requestParameters: UpdateMediaOperationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UpdateMediaResponse>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
    ...
    if (
      requestParameters.updateMediaRequest === null ||
      requestParameters.updateMediaRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "updateMediaRequest",
        "Required parameter requestParameters.updateMediaRequest was null or undefined when calling updateMedia."
      );
    }
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      UpdateMediaResponseFromJSON(jsonValue)
    );
  }
  ...
  async updateMedia(
    ...
    const response = await this.updateMediaRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
