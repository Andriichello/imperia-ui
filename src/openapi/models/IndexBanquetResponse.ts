...
export function IndexBanquetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexBanquetResponse {
...
export function IndexBanquetResponseToJSON(value?: IndexBanquetResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
