...
export type FamilyMemberRelationEnum = typeof FamilyMemberRelationEnum[keyof typeof FamilyMemberRelationEnum];
...
export function FamilyMemberFromJSONTyped(json: any, ignoreDiscriminator: boolean): FamilyMember {
    ...
    return {
        ...
        'relative': !exists(json, 'relative') ? undefined : CustomerFromJSON(json['relative']),
    };
}
