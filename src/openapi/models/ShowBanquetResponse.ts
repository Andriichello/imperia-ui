...
export function ShowBanquetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowBanquetResponse {
...
export function ShowBanquetResponseToJSON(value?: ShowBanquetResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
