...
export function StoreCommentRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreCommentRequest {
...
export function StoreCommentRequestToJSON(value?: StoreCommentRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
