...
export function DestroyWaiterResponseFromJSON(json: any): DestroyWaiterResponse {
    return DestroyWaiterResponseFromJSONTyped(json, false);
}

export function DestroyWaiterResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): DestroyWaiterResponse {
...
export function DestroyWaiterResponseToJSON(value?: DestroyWaiterResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
