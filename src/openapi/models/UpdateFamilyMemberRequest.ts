...
export type UpdateFamilyMemberRequestRelationEnum = typeof UpdateFamilyMemberRequestRelationEnum[keyof typeof UpdateFamilyMemberRequestRelationEnum];
...
export function UpdateFamilyMemberRequestFromJSON(json: any): UpdateFamilyMemberRequest {
    return UpdateFamilyMemberRequestFromJSONTyped(json, false);
}

export function UpdateFamilyMemberRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateFamilyMemberRequest {
...
export function UpdateFamilyMemberRequestToJSON(value?: UpdateFamilyMemberRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
