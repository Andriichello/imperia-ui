...
export function IndexCategoryResponseFromJSON(json: any): IndexCategoryResponse {
    return IndexCategoryResponseFromJSONTyped(json, false);
}

export function IndexCategoryResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IndexCategoryResponse {
...
export function IndexCategoryResponseToJSON(value?: IndexCategoryResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
