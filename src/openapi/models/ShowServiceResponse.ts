...
export function ShowServiceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowServiceResponse {
...
export function ShowServiceResponseToJSON(value?: ShowServiceResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
