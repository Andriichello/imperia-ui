...
export function StoreOrderRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreOrderRequest {
    ...
    return {
        ...
        'spaces': !exists(json, 'spaces') ? undefined : ((json['spaces'] as Array<any>).map(StoreOrderRequestSpaceFieldFromJSON)),
        'tickets': !exists(json, 'tickets') ? undefined : ((json['tickets'] as Array<any>).map(StoreOrderRequestTicketFieldFromJSON)),
        'services': !exists(json, 'services') ? undefined : ((json['services'] as Array<any>).map(StoreOrderRequestServiceFieldFromJSON)),
        'products': !exists(json, 'products') ? undefined : ((json['products'] as Array<any>).map(StoreOrderRequestProductFieldFromJSON)),
...
export function StoreOrderRequestToJSON(value?: StoreOrderRequest | null): any {
    ...
    return {
        ...
        'spaces': value.spaces === undefined ? undefined : ((value.spaces as Array<any>).map(StoreOrderRequestSpaceFieldToJSON)),
        'tickets': value.tickets === undefined ? undefined : ((value.tickets as Array<any>).map(StoreOrderRequestTicketFieldToJSON)),
        'services': value.services === undefined ? undefined : ((value.services as Array<any>).map(StoreOrderRequestServiceFieldToJSON)),
        'products': value.products === undefined ? undefined : ((value.products as Array<any>).map(StoreOrderRequestProductFieldToJSON)),
