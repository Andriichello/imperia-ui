...
export function AlternationFromJSONTyped(json: any, ignoreDiscriminator: boolean): Alternation {
    ...
    return {
        ...
        'performAt': (json['perform_at'] === null ? null : new Date(json['perform_at'])),
        'performedAt': (json['performed_at'] === null ? null : new Date(json['performed_at'])),
        'alterable': !exists(json, 'alterable') ? undefined : AlternationAlterableFromJSON(json['alterable']),
    };
}
...
export function AlternationToJSON(value?: Alternation | null): any {
    ...
    return {
        ...
        'performed_at': (value.performedAt === null ? null : value.performedAt.toISOString()),
