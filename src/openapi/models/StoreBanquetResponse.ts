...
export function StoreBanquetResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreBanquetResponse {
...
export function StoreBanquetResponseToJSON(value?: StoreBanquetResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
