...
export function StoreCustomerRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreCustomerRequest {
...
export function StoreCustomerRequestToJSON(value?: StoreCustomerRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
