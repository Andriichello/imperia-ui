...
export function ShowWaiterResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowWaiterResponse {
...
export function ShowWaiterResponseToJSON(value?: ShowWaiterResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
