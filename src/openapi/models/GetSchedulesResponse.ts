...
export function GetSchedulesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetSchedulesResponse {
...
export function GetSchedulesResponseToJSON(value?: GetSchedulesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
