...
export type UpdateBanquetRequestAdvanceAmountPaymentMethodEnum = typeof UpdateBanquetRequestAdvanceAmountPaymentMethodEnum[keyof typeof UpdateBanquetRequestAdvanceAmountPaymentMethodEnum];
...
export function UpdateBanquetRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateBanquetRequest {
...
export function UpdateBanquetRequestToJSON(value?: UpdateBanquetRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
