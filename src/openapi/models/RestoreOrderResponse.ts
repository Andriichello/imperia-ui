...
export function RestoreOrderResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): RestoreOrderResponse {
...
export function RestoreOrderResponseToJSON(value?: RestoreOrderResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
