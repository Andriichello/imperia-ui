...
export function MediaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Media {
    ...
    return {
        ...
        'variants': !exists(json, 'variants') ? undefined : ((json['variants'] as Array<any>).map(MediaFromJSON)),
    };
}
...
export function MediaToJSON(value?: Media | null): any {
    ...
    return {
        ...
        'variants': value.variants === undefined ? undefined : ((value.variants as Array<any>).map(MediaToJSON)),
    };
}
