...
export function SetModelMediaRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SetModelMediaRequest {
    ...
    return {
        ...
        'media': !exists(json, 'media') ? undefined : ((json['media'] as Array<any>).map(AttachingMediaFromJSON)),
    };
}

export function SetModelMediaRequestToJSON(value?: SetModelMediaRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'media': value.media === undefined ? undefined : ((value.media as Array<any>).map(AttachingMediaToJSON)),
    };
}
