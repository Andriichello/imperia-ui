...
export function StoreWaiterResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): StoreWaiterResponse {
...
export function StoreWaiterResponseToJSON(value?: StoreWaiterResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
