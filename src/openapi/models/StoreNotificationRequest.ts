...
export type StoreNotificationRequestChannelEnum =
  typeof StoreNotificationRequestChannelEnum[keyof typeof StoreNotificationRequestChannelEnum];
...
export function StoreNotificationRequestFromJSON(
  json: any
): StoreNotificationRequest {
  return StoreNotificationRequestFromJSONTyped(json, false);
}

export function StoreNotificationRequestFromJSONTyped(
  json: any,
...
export function StoreNotificationRequestToJSON(
  value?: StoreNotificationRequest | null
): any {
  if (value === undefined) {
    return undefined;
  }
