...
export function AttachingDiscountFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttachingDiscount {
    ...
    return {
        ...
        'discountableId': !exists(json, 'discountable_id') ? undefined : json['discountable_id'],
        'discountableType': !exists(json, 'discountable_type') ? undefined : json['discountable_type'],
    };
}
