...
export function ShowRestaurantReviewResponseFromJSON(json: any): ShowRestaurantReviewResponse {
    return ShowRestaurantReviewResponseFromJSONTyped(json, false);
}

export function ShowRestaurantReviewResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): ShowRestaurantReviewResponse {
...
export function ShowRestaurantReviewResponseToJSON(value?: ShowRestaurantReviewResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
