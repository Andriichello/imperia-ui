 ...
 * 
 * @export
 * @interface OutputFileContext
 */
export interface OutputFileContext {
    /**
     * 
     * @type {number}
     * @memberof OutputFileContext
     */
    id: number;
    /**
     * 
     ...
     * @memberof OutputFileContext
     */
    status?: OutputFileContextStatusEnum;
    /**
 ...
 * @export
 */
export const OutputFileContextStatusEnum = {
    Pending: 'Pending',
...
export type OutputFileContextStatusEnum = typeof OutputFileContextStatusEnum[keyof typeof OutputFileContextStatusEnum];


/**
 * Check if a given object implements the OutputFileContext interface.
 */
export function instanceOfOutputFileContext(value: object): boolean {
    let isInstance = true;
...
export function OutputFileContextFromJSON(json: any): OutputFileContext {
    return OutputFileContextFromJSONTyped(json, false);
}

export function OutputFileContextFromJSONTyped(json: any, ignoreDiscriminator: boolean): OutputFileContext {
...
export function OutputFileContextToJSON(value?: OutputFileContext | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
